  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="space-y-1.5">
          <div className="flex justify-between items-center px-1">
            ...
            <Link href="#" className="text-[12px] text-emerald-500/80 hover:text-emerald-400 transition-colors">Forgot password?</Link>
          </div>
      ...
      <p className="text-center text-sm text-gray-500 mt-8">
        ...
        <Link href="/signup" className="text-white hover:underline decoration-white/30 underline-offset-4">Create one for free</Link>
      </p>
    </>
  );
}

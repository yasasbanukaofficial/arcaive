          ...
          {plans.map((plan, index) => (
            ...
            >
              <div className="space-y-4">
                <span className="text-[12px] font-bold text-white/30 uppercase tracking-[0.2em] block">
                  {plan.name}
                </span>
                <div className="flex items-baseline gap-2">
                  <span className="text-[52px] font-medium tracking-[-0.04em] text-white">
                    {plan.price}
                  </span>
                ...
                <p className="text-white/40 text-[15px] font-medium leading-relaxed min-h-[50px]">
                  {plan.description}
                </p>
              </div>
                ...
                <div className="space-y-3">
                  {plan.features.map((feature) => (
                    <div key={feature} className="flex items-center gap-3">
                      ...
                      <span className="text-[14px] font-medium text-white/40 group-hover:text-white/60 transition-colors tracking-tight">
                        {feature}
                      </span>
                    </div>
                  ))}

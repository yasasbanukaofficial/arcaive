      ...
      <div className="max-w-[1240px] mx-auto">
        <div className="text-left mb-10">
          <SectionHeader
            ...
            subtitle="pricing."
          />
          <p className="text-white/40 text-lg max-w-2xl font-medium leading-relaxed tracking-tight">
        ...
        <div className="mb-8 flex items-center justify-center">
          <div className="mt-4 flex items-center gap-4">
            <span
              className={`text-sm transition-colors cursor-pointer ${!isYearly ? "text-white" : "text-gray-500"}`}
            ...
            <button
              ...
              className="w-11 h-6 rounded-full bg-white/10 relative transition-colors hover:bg-white/20"
            >
              <motion.div
                initial={false}
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-[10px] bg-white/5 border border-white/10 px-2 py-0.5 rounded-full text-white/60">
                20% OFF
              </span>
            </div>
          </div>

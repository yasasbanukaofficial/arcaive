...
const FinalCTASection: React.FC = () => {
  return (
    <div className="py-24 px-6 bg-[#0a0a0a] flex items-center justify-center">
      <section className="relative w-full max-w-6xl aspect-[2.5/1] md:aspect-[3.2/1] overflow-hidden rounded-xl border border-zinc-900/50">
        <CTABackground
        ...
        <div className="relative z-10 h-full w-full flex flex-col justify-center px-10 md:px-16">
          <CTAContent

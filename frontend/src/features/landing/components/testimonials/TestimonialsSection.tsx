...
export default function TestimonialsSection() {
  return (
    <section id="testimonials" className="bg-transparent py-40 px-6 lg:px-12 relative border-b border-white/5 overflow-hidden">
      <div className="max-w-[1800px] mx-auto relative z-10">
        <div className="flex flex-col gap-24">
          ...
          >
            <span className="font-sans text-[11px] font-bold uppercase tracking-[0.4em] text-white/30">03 — Stories</span>
            ...
            <div className="lg:col-span-8">
              ...
              >
                ...
                <div className="mt-16 flex flex-col gap-2">
                  <span className="font-sans text-[20px] font-bold text-white italic">{testimonials[0].author}</span>
                  <span className="font-sans text-[14px] text-white/30 uppercase tracking-[0.4em] font-medium">{testimonials[0].position}</span>
                </div>
              </motion.div>
            </div>
            ...
            <div className="lg:col-span-4 flex flex-col gap-16">
              {testimonials.slice(1).map((t, i) => (
                <motion.div
                  ...
                  className="flex flex-col gap-8 border-l border-white/10 pl-10"
                >
                  <p className="font-sans text-[18px] text-white/40 leading-relaxed italic font-light">
                    "{t.quote}"
                  </p>
                  <div className="flex flex-col gap-1">
                    <span className="font-sans text-[14px] font-bold text-white tracking-widest">{t.author}</span>
                    <span className="font-sans text-[12px] text-white/20 uppercase tracking-[0.3em] font-bold">{t.position}</span>
                  </div>
                </motion.div>
              ))}
            </div>

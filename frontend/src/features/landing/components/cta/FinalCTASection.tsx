  ...
  return (
    <section ref={container} className="scene-section items-center justify-center min-h-[90vh]">
      <div className="w-full relative z-10 flex flex-col items-center text-center cta-reveal">
        ...
        <Link 
          href="/register" 
          className="group inline-flex items-center gap-6 px-12 py-6 bg-[var(--text-primary)] text-[#0A0908] rounded-sm font-sans text-[14px] font-bold uppercase tracking-[0.2em] transition-all hover:bg-white"
        >
          INITIALIZE SWARM

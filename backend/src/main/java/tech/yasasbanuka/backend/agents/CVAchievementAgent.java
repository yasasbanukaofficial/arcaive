...
public interface CVAchievementAgent {
    @SystemMessage("""
            ...
            Your task is to transform a developer's raw CV data into "Technical Competency Units"
            ...
            they phrase the job requirement?" Then write that requirement AS the competency.
            ...
            → competencyTerm: "ORM Optimization & Zero-Dependency Data Mapping"
            → competencyDescription: "Able to develop high-performance, zero-dependency Java libraries
            ...
            → competencyTerm: "Secure Payment Integration & Financial Workflows"
            → competencyDescription: "Experienced in implementing production-grade financial transaction
            ...
            → competencyTerm: "Multi-Model LLM Orchestration & Agentic Design"
            → competencyDescription: "Able to architect sophisticated, model-agnostic AI engines using
            ...
            → competencyTerm: "Cross-Functional System Orchestration & Stakeholder Collaboration"
            → competencyDescription: "Able to lead and collaborate within multi-disciplinary teams—including
            ...
            → competencyTerm: "Secure Authentication & Identity Management"
            → competencyDescription: "Able to design and implement enterprise-grade authentication systems
            ...
            ### OUTPUT SCHEMA (strict JSON — no extra fields, no deviation):
            {
              ...
              "achievements": [
                {
                  "competencyTerm": "<2-6 word recruiter-style job requirement keyword>",
                  "competencyDescription": "<Professional Able to... or Experienced in... statement>"
                }
              ]
            }

            ### FIELD RULES:
            1. **competencyTerm** [REQUIRED — never null or empty]:
            ...
            2. **competencyDescription** [REQUIRED — never null or empty]:
            ...
            - Every competency MUST be something a recruiter would search for in a candidate database.
